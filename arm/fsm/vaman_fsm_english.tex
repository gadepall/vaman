...
\begin{abstract}
  This document shows how to use the pygmy to design a decade counter using a finite state machine (FSM).
...
\caption{Pin connection between the pygmy and seven segment display}
