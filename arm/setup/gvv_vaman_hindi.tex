...
\begin{lstlisting}
cd ˜
svn co https://github.com/gadepall/vaman/trunk/arm/codes/blink
cd GCC_Project
make
...
\end{lstlisting}
%
इससे हम ज्ञात कर सकते हैं की वामन के दीप का शमीलनकाल 1000 ms = 1 s।  
...
vTaskDelay(500);
\end{lstlisting}
से प्रतिस्थापित कर क्रमादेश का चालयन करें ।  क्या श्मीलनकाल में कोई परिवर्तन द्र्श्य है?
\item रक्तिम रंगोत्पदन के लिए निम्न गूढ़ का चालयन करें।  
\begin{lstlisting}
codes/red/src/main.c
\end{lstlisting}


यह विदित है कि यदि आवृत्ति 20 MHz है तो अतिकाल 1 निमिश है ।   
