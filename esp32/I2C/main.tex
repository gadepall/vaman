...
\title{ 
%	\logo{
	I2C Communication Between ESP32 and Arduino
%	}
}
%\title{
...
\end{table}
\section{Setting up the Master and Slave}
...
\item
Connect the ESP32 pins to Arduino pins as per Table \ref{Table:1}.
\begin{table}[h]
\centering
...
\item
Connect the ESP32 pins to LCD pins as per Table \ref{Table:2}.
\begin{table}[h]
\centering
...
\url {https://github.com/gadepall/vaman/blob/master/esp32/codes/ide/i2c/I2C_Sender_Arduino/src/main.cpp}

\item
Now configure ESP32 as a Master using the following code.\\
		\url {https://github.com/gadepall/vaman/blob/master/esp32/codes/ide/i2c/I2C_Reciever_ESP32/src/main.cpp}
