...
%%  LaTeX document. The table is based on the tabular package so  %%
%%  the tabular options (headers, footers...) can be set in the   %%
...
%%  The \settabulars command keeps column widths the same across  %%
