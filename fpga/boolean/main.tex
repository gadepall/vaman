...
\item Fig. \ref{fig:pin_sheet} shows the pin diagram for the Vaman.  Using the bank J5, connect the pins of  the seven segment display in Fig. \ref{fig:sevenseg} to the Vaman according to Table  \ref{table:vaman_dispdec}.  Make sure that the COM pin is connected to 3.3V through a resistor.
\begin{table}[!ht]
\centering
